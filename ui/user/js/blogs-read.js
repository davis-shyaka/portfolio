...
const baseURL = `http://localhost:3000/post/get/${postID}`
...
const callAPI = async () => {
  try {
    ...
    const ourBlog = data.data
    console.log('the fetched data: ', ourBlog)
    const { cover, id, title, caption, author, posted, reads, likes, content } =
      ourBlog[0]
